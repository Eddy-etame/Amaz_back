...
Comparer le **cahier des charges** (entités et modélisation DB, document Word utilisateur) avec l'**implémentation** actuelle (migrations MySQL + initialisation MongoDB).
