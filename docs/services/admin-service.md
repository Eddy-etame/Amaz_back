...
**Rôle:** interface d'administration (CRUD rapide sur MySQL) et point d'entrée séparé de l'API grand public.
...
- **MySQL** — même base que user-service / order-service pour les entités « relationnelles ».
...
| `MYSQL_*` ou `DATABASE_URL` | Connexion MySQL |
