...
- Les vendeurs sont des utilisateurs avec un **rôle** particulier ; certaines actions passent par des endpoints admin ou internes pour l'approbation (MySQL côté user-service / admin).
